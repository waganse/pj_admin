<?php
class Controller_Data_Master_Keyword extends Controller_Data_Base
{
    public $auth = false;
    public $data = array();
    public $user_id = 0;
    ...
    public function get_data()
    {
        ...
        $this->data = Model_M_Keyword::find($cond, array(
            'where' => array(
    ...
    public function post_data()
    {
        ...
        $model = Model_M_Keyword::forge($props);
        $model->save();
