<?php
class Controller_Data_Master_Calendar extends Controller_Data_Base
{
    public $auth = false;
    public $data = array();
    public $user_id = 0;
    ...
    public function get_data()
    {
        ...
        $this->data = Model_M_Calendar::find($cond, array(
            'where' => array(
    ...
    public function post_data()
    {
        ...
        $model = Model_M_Calendar::forge($props);
        $model->save();
    ...
    public function put_data($id = null)
    {
        ...
        $model = Model_M_Calendar::find($id);
