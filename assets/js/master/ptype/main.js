...
define('master/ptype/views/view',[
...
define('master/ptype/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_PROJECT_TYPE
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_PROJECT_TYPE;
        }
    });
...
define('master/ptype/router/router',[
    'master/ptype/views/view',
    'master/ptype/models/model',
...
define("master/ptype/main", function(){});
