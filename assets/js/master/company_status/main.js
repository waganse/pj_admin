...
define('master/company_status/views/view',[
...
define('master/company_status/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_COMPANY_STATUS
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_COMPANY_STATUS;
        },
    });
...
define('master/company_status/router/router',[
...
define("master/company_status/main", function(){});
