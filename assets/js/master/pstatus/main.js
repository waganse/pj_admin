...
define('master/pstatus/views/view',[
...
define('master/pstatus/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_PROJECT_STATUS
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_PROJECT_STATUS;
        }
    });
...
define('master/pstatus/router/router',[
    'master/pstatus/views/view',
    'master/pstatus/models/model',
...
define("master/pstatus/main", function(){});
