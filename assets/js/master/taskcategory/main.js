...
define('master/taskcategory/views/view',[
...
define('master/taskcategory/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_TASK_CATEGORY
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_TASK_CATEGORY;
        }
    });
...
define('master/taskcategory/router/router',[
...
require([
    'backbone',
    'master/taskcategory/router/router'
...
define("master/taskcategory/main", function(){});
