...
define('master/pstatus_o/views/view',[
...
define('master/pstatus_o/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_OUT_PROJECT_STATUS
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_OUT_PROJECT_STATUS;
        }
    });
...
define('master/pstatus_o/router/router',[
    'master/pstatus_o/views/view',
    'master/pstatus_o/models/model',
...
require([
    'backbone',
    'master/pstatus_o/router/router'
...
define("master/pstatus_o/main", function(){});
