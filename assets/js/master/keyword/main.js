...
define('master/keyword/views/view',[
...
define('master/keyword/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_KEYWORD
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_KEYWORD;
        }
    });
...
define('master/keyword/router/router',[
    'master/keyword/views/view',
    'master/keyword/models/model',
...
define("master/keyword/main", function(){});
