...
define('master/role/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = MasterModels.ItemModel.extend({
        api: CONST.API_MASTER_ROLE
    });

    ItemCollection = MasterModels.ItemCollection.extend({
        url: function() {
...
define('master/role/router/router',[
    'master/role/views/view',
    'master/role/models/model',
...
define("master/role/main", function(){});
