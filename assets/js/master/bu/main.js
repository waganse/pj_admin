    ...
    ItemModel = Backbone.Model.extend({
        ...
        parse: function(response) {
            _.each(M_BU_CATEGORY, function(item) {
                if (item.id == response.bu_group_id) {
                    response.bu_category = item.name;
                }
            });
            return response;
        }
...
define('master/bu/template/template',[
    'underscore',
], function(_) {
    window.JST || (window.JST = {});
...
define('master/bu/views/view',[
    'jquery',
    'backbone',
    'underscore',
    'master/bu/models/model',
    'master/base/views/view',
    'master/bu/template/template',
    'bootstrap',
    'validation',
], function($, Backbone, _, Models, MasterView) {
    var AppView,
        ItemListView,
        ItemView,
        ItemEditView,
    ...
    AppView = MasterView.MasterAppView.extend();

    ItemListView = MasterView.MasterListView.extend({
        render: function() {
            var self = this,
                paramObj = {};
...
define('master/bu/router/router',[
    'master/bu/views/view',
    'master/bu/models/model',
...
define("master/bu/main", function(){});
