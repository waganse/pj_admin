...
define('master/models/model-master',[
    'jquery',
    'backbone',
    'underscore'
], function($, Backbone, _) {
...
define('master/template/template',[
    'underscore',
], function(_) {
    ...
    window.JST['show'] = _.template(
            ...
            <td class="edit">\
              ...
              <p><a class="btn btn-default glyphicon glyphicon-trash js-delete"></a></p>\
            </td>\
            <td><%= id %></td>\
    ...
    window.JST['cal-create'] = _.template(
        '<div id="modal-master-edit" class="modal fade">\
          <div class="modal-dialog">\
            <div class="modal-content">\
              <div class="modal-header">\
              ...
              <div class="modal-body">\
                <div class="form-group">\
                    <label>Item (*)</label>\
                    <input type="text" class="form-control js-datepicker" placeholder="Enter item name" value="" data-role="edit" data-edit="item" data-func="validation" data-required="true" data-title="Item" readonly="readonly">\
                </div>\
                <div class="form-group">\
                    <label>Description</label>\
                    <input type="text" class="form-control" placeholder="Enter description" value="" data-role="edit" data-edit="description">\
    ...
    window.JST['cal-edit'] = _.template(
        '<div id="modal-master-edit" class="modal fade">\
          <div class="modal-dialog">\
            <div class="modal-content">\
              <div class="modal-header">\
              ...
              <div class="modal-body">\
                <div class="form-group">\
                    <label>Item (*)</label>\
                    <input type="text" class="form-control js-datepicker" placeholder="Enter item name" value="<%= item %>" data-role="edit" data-edit="item" data-func="validation" data-required="true" data-title="Item" readonly="readonly">\
                </div>\
                <div class="form-group">\
                    <label>Description</label>\
                    <input type="text" class="form-control" placeholder="Enter description" value="<%= description %>" data-role="edit" data-edit="description">\
...
define('master/views/view-master',[
    'jquery',
    'backbone',
    'underscore',
    'master/models/model-master',
    ...
    var MasterAppView,
        ...
        PostAppView,
        RoleAppView,
        HolidayStatusAppView,
        TaskCategoryAppView,
        TaskChildCategoryAppView,
        TaskAppView,
        BuCategoryAppView,
        BuAppView,
        ProjectTypeAppView,
        ProjectTypeExternalAppView,
        ProjectStatusAppView,
        ProjectStatusExternalAppView,
        KeywordAppView,
        DeviceAppView,
        CompanyStatusAppView,
        CompanyScaleAppView,
        PaymentByAppView,
        CalendarAppView;

    MasterAppView = Backbone.View.extend({
        el: $('#main'),
        ...
        initialize: function() {
            ...
            this.listView = new MasterListView({
                collection: this.collection
            });
        }
    });

    UserStatusAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.UserStatusModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    TeamAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.TeamModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    PostAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
    ...
    RoleAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
    ...
    HolidayStatusAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.HolidayStatusModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    TaskCategoryAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.TaskCategoryModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    TaskChildCategoryAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.TaskChildCategoryModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    TaskAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
    ...
    BuCategoryAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.BuCategoryModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    BuAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.BuModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    ProjectTypeAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.ProjectTypeModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    ProjectTypeExternalAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            console.log(1);
            new MasterEditView({
                model: new Models.ProjectTypeExternalModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    ProjectStatusAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.ProjectStatusModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    ProjectStatusExternalAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.ProjectStatusExternalModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    KeywordAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.KeywordModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    DeviceAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
    ...
    CompanyStatusAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.CompanyStatusModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    CompanyScaleAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.CompanyScaleModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    PaymentByAppView = MasterAppView.extend({
        onCreateClick: function(e) {
            new MasterEditView({
                model: new Models.PaymentByModel(),
                collection: this.collection
            });
            e.preventDefault();
        }
    ...
    CalendarAppView = MasterAppView.extend({
        initialize: function() {
            $('#master-list').find('tbody').empty();
            this.listView = new CalendarListView({
                collection: this.collection
            });
        },

        onCreateClick: function(e) {
            new CalendarEditView({
    ...
    MasterListView = Backbone.View.extend({
        el: $('#main-content'),
        ...
        renderNoRecord: function() {
            if (this.collection.models.length === 0) {
                $('#master-list')
                    .append($('<tr class="js-no-rec">')
                        .append('<td colspan="5">No record</td>')
                );
            } else {
                $('.js-no-rec').remove();
            }
    ...
    CalendarListView = MasterListView.extend({
        render: function() {
            var self = this,
                paramObj = {};
    ...
    MasterItemView = Backbone.View.extend({
        events: {
    ...
    CalendarItemView = MasterItemView.extend({
        onEditClick: function(e) {
            new CalendarEditView({
                model: this.model
            });
    ...
    MasterEditView = Backbone.View.extend({
        template: null,
    ...
    CalendarEditView = MasterEditView.extend({
        initialize: function() {
            this.template = (this.model.get('id'))? JST['cal-edit'](this.model.toJSON()) : JST['cal-create']();
            this.render();
        },
    ...
    MasterDeleteView = Backbone.View.extend({
        events: {
            'click .js-delete': 'onDeleteClick',
            'hidden.bs.modal': 'onCloseClick'
        },
    ...
    return {
        UserStatusAppView: UserStatusAppView,
        TeamAppView: TeamAppView,
        PostAppView: PostAppView,
        RoleAppView: RoleAppView,
        HolidayStatusAppView: HolidayStatusAppView,
        TaskCategoryAppView: TaskCategoryAppView,
        TaskChildCategoryAppView: TaskChildCategoryAppView,
        TaskAppView: TaskAppView,
        BuCategoryAppView: BuCategoryAppView,
        BuAppView: BuAppView,
        ProjectTypeAppView: ProjectTypeAppView,
        ProjectTypeExternalAppView: ProjectTypeExternalAppView,
        ProjectStatusAppView: ProjectStatusAppView,
        ProjectStatusExternalAppView: ProjectStatusExternalAppView,
        KeywordAppView: KeywordAppView,
        DeviceAppView: DeviceAppView,
        CompanyStatusAppView: CompanyStatusAppView,
        CompanyScaleAppView: CompanyScaleAppView,
        PaymentByAppView: PaymentByAppView,
        CalendarAppView: CalendarAppView
    };
});
define('master/router/router-master',[
    'backbone',
    'master/views/view-master',
    'master/models/model-master'
    ...
    MasterRouter = Backbone.Router.extend({
        ...
        routes: {
            ...
            'task_sub_category': 'taskChildCategory',
            'task': 'task',
            'bu_category': 'buCategory',
            'bu': 'bu',
            'type': 'projectType',
            'type_external': 'projectTypeExternal',
            'project_status': 'projectStatus',
            'project_status_external': 'projectStatusExternal',
            'keyword': 'keyword',
            'device': 'device',
        ...
        userStatus: function() {
            new Views.UserStatusAppView({
                collection: new Models.UserStatusCollection()
            });
        },

        team: function() {
            new Views.TeamAppView({
                collection: new Models.TeamCollection()
            });
        },

        post: function() {
            new Views.PostAppView({
                collection: new Models.PostCollection()
            });
        },

        role: function() {
            new Views.RoleAppView({
                collection: new Models.RoleCollection()
            });
        },

        holidayStatus: function() {
            new Views.HolidayStatusAppView({
                collection: new Models.HolidayStatusCollection()
            });
        },

        taskCategory: function() {
            new Views.TaskCategoryAppView({
                collection: new Models.TaskCategoryCollection()
            });
        },

        taskChildCategory: function() {
            new Views.TaskChildCategoryAppView({
                collection: new Models.TaskChildCategoryCollection()
            });
        },

        task: function() {
            new Views.TaskAppView({
                collection: new Models.TaskCollection()
            });
        },

        buCategory: function() {
            new Views.BuCategoryAppView({
                collection: new Models.BuCategoryCollection()
            });
        },

        bu: function() {
            new Views.BuAppView({
                collection: new Models.BuCollection()
            });
        },

        projectType: function() {
            new Views.ProjectTypeAppView({
                collection: new Models.ProjectTypeCollection()
            });
        },

        projectTypeExternal: function() {
            new Views.ProjectTypeExternalAppView({
                collection: new Models.ProjectTypeExternalCollection()
            });
        },

        projectStatus: function() {
            new Views.ProjectStatusAppView({
                collection: new Models.ProjectStatusCollection()
            });
        },

        projectStatusExternal: function() {
            new Views.ProjectStatusExternalAppView({
                collection: new Models.ProjectStatusExternalCollection()
            });
        },

        keyword: function() {
            new Views.KeywordAppView({
                collection: new Models.KeywordCollection()
            });
        },

        device: function() {
            new Views.DeviceAppView({
                collection: new Models.DeviceCollection()
            });
        },

        companyStatus: function() {
            new Views.CompanyStatusAppView({
                collection: new Models.CompanyStatusCollection()
            });
        },

        companyScale: function() {
            new Views.CompanyScaleAppView({
                collection: new Models.CompanyScaleCollection()
            });
        },

        paymentBy: function() {
            new Views.PaymentByAppView({
                collection: new Models.PaymentByCollection()
            });
        },

        calendar: function() {
            new Views.CalendarAppView({
                collection: new Models.CalendarCollection()
            });
        }
    });
