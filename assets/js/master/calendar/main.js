...
define('master/calendar/models/model',[
    'jquery',
    'backbone',
    'underscore',
    'const'
    ...
    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_CALENDAR;
        },
...
define('master/calendar/template/template',[
    'underscore',
], function(_) {
...
define('master/calendar/views/view',[
    'jquery',
    'backbone',
    'underscore',
    ...
    ItemListView = Backbone.View.extend({
        ...
        renderNoRecord: function() {
            if (this.collection.models.length === 0) {
                $('#item-list')
                    .append($('<td colspan="5" class="js-no-rec">')
                        .append('<p>No record</p>')
                );
            } else {
                $('.js-no-rec').remove();
            }
...
define('master/calendar/router/router',[
    'backbone',
    'master/calendar/views/view',
    'master/calendar/models/model'
...
define("master/calendar/main", function(){});
