...
define('master/team/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_TEAM
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_TEAM;
        }
    });
...
define('master/team/router/router',[
    'master/team/views/view',
    'master/team/models/model',
...
define("master/team/main", function(){});
