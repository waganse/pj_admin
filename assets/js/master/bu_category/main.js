...
define('master/base/models/model',[
    'jquery',
    'backbone',
    'underscore',
    'const'
...
define('master/base/template/template',[
    'underscore',
], function(_) {
...
define('master/base/views/view',[
    'jquery',
    'backbone',
    'underscore',
    'master/base/models/model',
    'master/base/template/template',
    'bootstrap',
    'validation',
...
console.log(self.model);
    ...
    return {
        MasterAppView: MasterAppView
    };
});
define('master/bu_category/views/view',[
    'master/base/views/view'
], function(MasterViews) {
    var AppView;

    AppView = MasterViews.MasterAppView.extend();

    return {
        AppView: AppView
    };
});
define('master/bu_category/models/model',[
    'const',
    'master/base/models/model'
], function(CONST, MasterModels) {
    var ItemModel,
        ItemCollection;

    ItemModel = MasterModels.MasterModel.extend({
        api: CONST.API_MASTER_BU_CATEGORY
    });

    ItemCollection = MasterModels.MasterCollection.extend({
        url: function() {
            return CONST.API_MASTER_BU_CATEGORY;
        }
    });
...
define('master/base/router/router',[
    'backbone',
    'master/base/views/view',
    'master/base/models/model'
], function(Backbone, Views, Models) {
    var MasterItemRouter;

    MasterItemRouter = Backbone.Router.extend({
        routes: {
            '': 'all'
        },
        ...
        all: function() {
            new Views.MasterAppView({
                collection: new Models.ItemCollection()
            });
        }
    });

    return MasterItemRouter;
});
define('master/bu_category/router/router',[
    'master/bu_category/views/view',
    'master/bu_category/models/model',
    'master/base/router/router'
], function(Views, Models, MasterRouter) {
    var ItemRouter;

    ItemRouter = MasterRouter.extend({
        all: function() {
            new Views.AppView({
                collection: new Models.ItemCollection()
            });
...
require([
    'backbone',
    'master/bu_category/router/router'
...
define("master/bu_category/main", function(){});
