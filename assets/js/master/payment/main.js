...
define('master/payment/views/view',[
...
define('master/payment/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_PAYMENT
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_PAYMENT;
        }
    });
...
define('master/payment/router/router',[
    'master/payment/views/view',
    'master/payment/models/model',
...
define("master/payment/main", function(){});
