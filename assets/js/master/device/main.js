...
define('master/device/views/view',[
...
define('master/device/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_DEVICE,
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_DEVICE;
        }
    });
...
define('master/device/router/router',[
...
define("master/device/main", function(){});
