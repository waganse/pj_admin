...
define('master/ptype_o/views/view',[
...
define('master/ptype_o/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_OUT_PROJECT_TYPE
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_OUT_PROJECT_TYPE;
        }
    });
...
define('master/ptype_o/router/router',[
...
define("master/ptype_o/main", function(){});
