...
define('master/company_scale/views/view',[
...
define('master/company_scale/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_COMPANY_SCALE
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_COMPANY_SCALE;
        }
    });
...
define('master/company_scale/router/router',[
    'master/company_scale/views/view',
    'master/company_scale/models/model',
...
define("master/company_scale/main", function(){});
