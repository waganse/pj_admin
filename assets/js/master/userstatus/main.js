...
define('master/userstatus/views/view',[
...
define('master/userstatus/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_USER_STATUS
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_USER_STATUS;
        }
    });
...
define('master/userstatus/router/router',[
...
require([
    'backbone',
    'master/userstatus/router/router'
...
define("master/userstatus/main", function(){});
