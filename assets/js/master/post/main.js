...
define('master/post/models/model',[
    'const',
    'master/base/models/model'
    ...
    ItemModel = Backbone.Model.extend({
        api: CONST.API_MASTER_POST
    });

    ItemCollection = Backbone.Collection.extend({
        url: function() {
            return CONST.API_MASTER_POST;
        }
    });
...
define('master/post/router/router',[
...
define("master/post/main", function(){});
