...
define('ext_project/models/model',[
    'jquery',
    'backbone',
    'underscore',
    'const'
...
define('ext_project/template/template',[
    'underscore',
], function(_) {
    ...
    ItemView = Backbone.View.extend({
        ...
        setNames: function() {
            var self = this,
                ...
                directorObj = _.find(M_USER, function(item) {
                    return (item.id == self.model.get('director_id'));
                }),
                creatorObj = _.find(M_USER, function(item) {
...
define('ext_project/router/router',[
    'backbone',
...
define("ext_project/main", function(){});
