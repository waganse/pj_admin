...
define('user/models/model',[
    ...
    ItemModel = Backbone.Model.extend({
        defaults: {
            ...
            last_login_str: '0000-00-00 00:00:00'
        },
    ...
    ItemCollection = Backbone.Collection.extend({
        ...
        parse: function(response) {
            _.each(response, function(data) {
                var d = new Date(data.last_login * 1000),
                    year = d.getFullYear(),
                    month = d.getMonth() + 1,
                    day  = d.getDate(),
                ...
                data.last_login_str = year + '-' + month + '-' + day + ' ' + hour + ':' + min + ':' + sec;
...
define('user/template/template',[
    ...
    window.JST['vtitle'] = _.template(
        '<div class="list-htitle">\
            ...
            <div class="col-4 col"><span>Nick name</span></div>\
        </div>'
    );

    window.JST['htitle'] = _.template(
        '<div class="list-htitle">\
            <div class="col-4 col no-bdr-r"><span>Team</span></div>\
            <div class="col-4 col"><span>Role</span></div>\
            <div class="col-3 col"><span>Status</span></div>\
            <div class="col-7 col"><span>Last login</span></div>\
            <div class="col-7 col"><span>Updated</span></div>\
            <div class="col-7 col"><span>Created</span></div>\
        </div>'
    );
    ...
    window.JST['vitem'] = _.template(
            ...
            <div class="col-8 col"><span><%= last_name %>,&nbsp;<%= first_name %></span></div>\
            <div class="col-4 col"><span><%= nickname %></span></div>'
    );

    window.JST['hitem'] = _.template(
            '<div class="col-4 col"><span><%= team %></span></div>\
            <div class="col-4 col"><span><%= role %></span></div>\
            <div class="col-3 col"><span><%= status %></span></div>\
            <div class="col-7 col"><span><%= last_login_str %></span></div>\
            <div class="col-7 col"><span><%= updated_at %></span></div>\
            <div class="col-7 col"><span><%= created_at %></span></div>'
    );
              ...
              <div class="modal-body">\
                ...
                <div class="row">\
                    <div class="form-group col-md-4">\
                        ...
                        <input type="text" class="form-control" placeholder="Taro" value="" data-role="edit" data-edit="first_name" data-func="validation" data-required="true" data-title="First name">\
                    </div>\
                    <div class="form-group col-md-4">\
                        <label>Last name (*)</label>\
                        <input type="text" class="form-control" placeholder="Rakuten" value="" data-role="edit" data-edit="last_name" data-func="validation" data-required="true" data-title="Last name">\
                    </div>\
                    <div class="form-group col-md-4">\
                        <label>Nickname (*)</label>\
                        <input type="text" class="form-control" placeholder="Mickey" value="" data-role="edit" data-edit="nickname" data-func="validation" data-required="true" data-title="Nickname">\
                    </div>\
                </div>\
                <div class="row">\
                    <div class="form-group col-md-4">\
                        <label>Password (*)</label>\
                        <input type="password" class="form-control" placeholder="Password" value="" data-role="edit" data-edit="password" data-func="validation" data-required="true" data-title="password">\
                    </div>\
                    <div class="form-group col-md-4">\
                        <label>Password (confirm)</label>\
                        <input type="password" class="form-control" placeholder="Password" value="" data-role="edit" data-edit="password_2" data-func="validation" data-required="true" data-title="password">\
                    </div>\
                </div>\
                <div class="form-group">\
                    <label>Role</label>\
