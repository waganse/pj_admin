...
define('company/template/template',[
    'underscore',
], function(_) {
...
define('company/views/view',[
    ...
    'validation',
    'trunk'
], function($, Backbone, _, Models, CONST, MasterViews) {
    var AppView,
        ItemListView,
        ItemView,
        ItemEditView,
...
define('company/router/router',[
    ...
    CompanyRouter = Backbone.Router.extend({
